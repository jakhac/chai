...
namespace {
	...
	//	move_t enPasDisCheck = serializeMove(F4, E3, Piece::EMPTY, Piece::EMPTY, MFLAG_EP);
	//	move_t captureDisCheck = serializeMove(F4, G3, Piece::Q, Piece::EMPTY, Piece::EMPTY);
	//	move_t legalMove = serializeMove(B7, B6, Piece::EMPTY, Piece::EMPTY, Piece::EMPTY);
	...
	//	move_t pawnPushCheck1 = serializeMove(D7, D6, Piece::EMPTY, Piece::EMPTY, Piece::EMPTY);
	//	move_t pawnPushCheck2 = serializeMove(F7, F5, Piece::EMPTY, Piece::EMPTY, MFLAG_PS);
	//	move_t knightJump = serializeMove(B8, C6, Piece::EMPTY, Piece::EMPTY, Piece::EMPTY);
	...
	//	move_t enPasDisCheck1 = serializeMove(F4, E3, Piece::EMPTY, Piece::EMPTY, MFLAG_EP);
	...
	//	move_t enPasDisCheck2 = serializeMove(F4, E3, Piece::EMPTY, Piece::EMPTY, MFLAG_EP);
	...
	//	move_t enPasDisCheck3 = serializeMove(F4, E3, Piece::EMPTY, Piece::EMPTY, MFLAG_EP);
	...
	//	move_t enPasDisCheck4 = serializeMove(F4, E3, Piece::EMPTY, Piece::EMPTY, MFLAG_EP);
	...
	//	move_t kingMovesCheck1 = serializeMove(D6, C6, Piece::EMPTY, Piece::EMPTY, Piece::EMPTY);
	//	move_t kingMovesCheck2 = serializeMove(D6, D5, Piece::EMPTY, Piece::EMPTY, Piece::EMPTY);
	//	move_t legalKingMove = serializeMove(D6, C5, Piece::EMPTY, Piece::EMPTY, Piece::EMPTY);
